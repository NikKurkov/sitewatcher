...
async def maybe_send_alert(update, context: ContextTypes.DEFAULT_TYPE, domain: str, results) -> None:
    ...
    try:
        ...
        if last_sent_at is not None:
            storage.upsert_alert_state(domain, overall, last_sent_at.isoformat())
